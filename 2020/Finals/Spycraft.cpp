...
struct rect{
	...
	rect dist(rect other){
		if ( inside(other.a) || inside (other.b) || inside(other.c) || inside(other.d) || other.inside(a) || other.inside(b) || other.inside(c) || other.inside(d)){
			rect n;
		...
		if ( b.x <= other.a.x ){
			if ( other.a.x-b.x >= c.y-other.b.y && other.a.x-b.x >= other.d.y-a.y ){
				if ( other.a.x-b.x < m ){
					n.init(b.x, min(a.y, other.a.y+other.a.x-b.x), a.x, max(c.y, other.d.y-other.a.x+b.x));
					m = other.a.x-b.x;
				}
			}
		}
		...
		if ( a.y <= other.c.y ){
			if ( other.c.y-a.y >= other.a.x-d.x && other.c.y-a.y >= c.x-other.d.x ){
				if ( other.c.y - a.y < m ){
					n.init(max(a.x, other.a.x -other.c.y+a.y), d.y, min(d.x, other.d.x+other.c.y-a.y), d.y);
					m = other.c.y-a.y;
				}
			}
		}
